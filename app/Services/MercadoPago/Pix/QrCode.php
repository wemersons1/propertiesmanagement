...
namespace App\Services\MercadoPago\Pix;
...
class QrCode {
    ...
    public function execute($request) {
        ...
        $paymentTreated['qr_code'] = $payment->point_of_interaction->transaction_data->qr_code;
        $paymentTreated['qr_code_base64'] = $payment->point_of_interaction->transaction_data->qr_code_base64;

        return $paymentTreated;
    }
