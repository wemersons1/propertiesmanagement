(self["webpackChunk"] = self["webpackChunk"] || []).push([["resources_js_src_System_Admin_PaymentsAdvisors_Create_index_js"],{
...
/***/ "./resources/js/src/System/Admin/PaymentsAdvisors/Create/index.js":
/*!************************************************************************!*\
  !*** ./resources/js/src/System/Admin/PaymentsAdvisors/Create/index.js ***!
  \************************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony import */ var _Create_module_css__WEBPACK_IMPORTED_MODULE_16__ = __webpack_require__(/*! ./Create.module.css */ "./resources/js/src/System/Admin/PaymentsAdvisors/Create/Create.module.css");
...
var Create = function Create() {
  ...
  var _useState23 = (0,react__WEBPACK_IMPORTED_MODULE_0__.useState)('advisor'),
  ...
  var _useState25 = (0,react__WEBPACK_IMPORTED_MODULE_0__.useState)(''),
      ...
      dateInit = _useState26[0],
      setDateInit = _useState26[1];
  ...
  (0,react__WEBPACK_IMPORTED_MODULE_0__.useEffect)(function () {
    axios__WEBPACK_IMPORTED_MODULE_6___default().get('/api/v1/users?role_name=seller&all=1', {
      headers: {
    ...
    axios__WEBPACK_IMPORTED_MODULE_6___default().get('/api/v1/advisors?all=1', {
      headers: {
        Authorization: "Bearer ".concat(token)
      }
    }).then(function (response) {
      setAllAdvisors(response.data.map(function (seller) {
        return {
          value: seller.id,
          label: seller.name
        };
  ...
  var handlerSubmit = function handlerSubmit(e) {
    ...
    axios__WEBPACK_IMPORTED_MODULE_6___default().post('/api/v1/payment-employee-advisor', data, {
      headers: {
        Authorization: "Bearer ".concat(token)
      }
    }).then(function (response) {
  ...
  (0,react__WEBPACK_IMPORTED_MODULE_0__.useEffect)(function () {
    if (!(0,_Hook_util_help__WEBPACK_IMPORTED_MODULE_12__.isObjectEmpty)(employeeChanged) && dateInit.length && dateEnd.length) {
      var params = {};
      ...
      params['type'] = type;
      params['page'] = page;
      axios__WEBPACK_IMPORTED_MODULE_6___default().get("/api/v1/payment-employee-advisor/commission", {
        headers: {
          Authorization: "Bearer ".concat(token)
        },
        params: params
        ...
        setAllItems(response.data.all_transactions.data.map(function (item) {
  ...
  if (loadingPaymentsForms) return /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_17__.jsx)(_components_Spinner__WEBPACK_IMPORTED_MODULE_15__["default"], {});
