"use strict";
(self["webpackChunk"] = self["webpackChunk"] || []).push([["resources_js_src_System_Admin_Employees_Employee_index_js"],{
...
/***/ "./resources/js/src/System/Admin/Employees/Employee/index.js":
/*!*******************************************************************!*\
  !*** ./resources/js/src/System/Admin/Employees/Employee/index.js ***!
  \*******************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony import */ var _components_Select2__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ../../../../components/Select2 */ "./resources/js/src/components/Select2/index.js");
...
var Employee = function Employee() {
  var _useState = (0,react__WEBPACK_IMPORTED_MODULE_0__.useState)(false),
      ...
      sendingEmployee = _useState2[0],
      setSendingEmployee = _useState2[1];
  ...
  var _useState5 = (0,react__WEBPACK_IMPORTED_MODULE_0__.useState)([]),
      ...
      rolesChange = _useState6[0],
      setRolesChange = _useState6[1];
  ...
  var _useState15 = (0,react__WEBPACK_IMPORTED_MODULE_0__.useState)(''),
      ...
      phone1 = _useState16[0],
      setPhone1 = _useState16[1];

  var _useState17 = (0,react__WEBPACK_IMPORTED_MODULE_0__.useState)(''),
      _useState18 = _slicedToArray(_useState17, 2),
      phone2 = _useState18[0],
      setPhone2 = _useState18[1];

  var _useState19 = (0,react__WEBPACK_IMPORTED_MODULE_0__.useState)(''),
      _useState20 = _slicedToArray(_useState19, 2),
      admissionDate = _useState20[0],
      setAdmissionDate = _useState20[1];

  var _useState21 = (0,react__WEBPACK_IMPORTED_MODULE_0__.useState)(''),
      _useState22 = _slicedToArray(_useState21, 2),
      emittingOrgan = _useState22[0],
      setEmittingOrgan = _useState22[1];

  var _useState23 = (0,react__WEBPACK_IMPORTED_MODULE_0__.useState)(true),
      _useState24 = _slicedToArray(_useState23, 2),
      active = _useState24[0],
      setActive = _useState24[1];

  var _useState25 = (0,react__WEBPACK_IMPORTED_MODULE_0__.useState)(''),
      _useState26 = _slicedToArray(_useState25, 2),
      commission = _useState26[0],
      setCommission = _useState26[1];
  ...
  var _useState29 = (0,react__WEBPACK_IMPORTED_MODULE_0__.useState)(false),
      ...
      sweetShow = _useState30[0],
      setSweetShow = _useState30[1];

  var _useState31 = (0,react__WEBPACK_IMPORTED_MODULE_0__.useState)('success'),
      _useState32 = _slicedToArray(_useState31, 2),
      sweetType = _useState32[0],
      setSweetType = _useState32[1];

  var _useState33 = (0,react__WEBPACK_IMPORTED_MODULE_0__.useState)(''),
      _useState34 = _slicedToArray(_useState33, 2),
      sweetText = _useState34[0],
      setSweetText = _useState34[1];

  var _useState35 = (0,react__WEBPACK_IMPORTED_MODULE_0__.useState)(''),
      _useState36 = _slicedToArray(_useState35, 2),
      sweetTitle = _useState36[0],
      setSweetTitle = _useState36[1];

  var _useState37 = (0,react__WEBPACK_IMPORTED_MODULE_0__.useState)(false),
      _useState38 = _slicedToArray(_useState37, 2),
      success = _useState38[0],
      setSuccess = _useState38[1];

  var _useState39 = (0,react__WEBPACK_IMPORTED_MODULE_0__.useState)([]),
      _useState40 = _slicedToArray(_useState39, 2),
      allRoles = _useState40[0],
      setAllRoles = _useState40[1];
  ...
  var _useState43 = (0,react__WEBPACK_IMPORTED_MODULE_0__.useState)(2),
      _useState44 = _slicedToArray(_useState43, 2),
      role = _useState44[0],
      setRole = _useState44[1];
  ...
  var _useState45 = (0,react__WEBPACK_IMPORTED_MODULE_0__.useState)(true),
      ...
      loadingEmployee = _useState46[0],
      setLoadingEmployee = _useState46[1];

  (0,react__WEBPACK_IMPORTED_MODULE_0__.useEffect)(function () {
    axios__WEBPACK_IMPORTED_MODULE_6___default().get("/api/v1/users/roles", {
      headers: {
        Authorization: "Bearer ".concat(token)
      }
    }).then(function (response) {
      setAllRoles(response.data.map(function (role) {
        return {
          value: role.id,
          label: (0,_Hook_util_help__WEBPACK_IMPORTED_MODULE_9__.formatTypeUser)(role.name)
        };
      }));
    })["finally"](function () {
      return setLoading(false);
    });
    axios__WEBPACK_IMPORTED_MODULE_6___default().get("/api/v1/employees/".concat(id), {
      headers: {
        Authorization: "Bearer ".concat(token)
      }
    }).then(function (response) {
      var admissionDateTreated = response.data.admission_date.split('-');
      admissionDateTreated = "".concat(admissionDateTreated[2], "/").concat(admissionDateTreated[1], "/").concat(admissionDateTreated[0]);
      var birthDateTreated = response.data.birth_date.split('-');
      birthDateTreated = "".concat(birthDateTreated[2], "/").concat(birthDateTreated[1], "/").concat(birthDateTreated[0]);
      ...
      setRolesChange(response.data.roles.map(function (role) {
        return {
          value: role.id,
          label: (0,_Hook_util_help__WEBPACK_IMPORTED_MODULE_9__.formatTypeUser)(role.name)
        };
      ...
      return setLoadingEmployee(false);
    });
  }, []);
  ...
  var handlerSubmit = function handlerSubmit(e) {
    ...
    e.preventDefault();
    var data = {};
    var birthTreated = birthDate.split('/');
    var admission = admissionDate.split('/');
    var rolesTreated = [];
    rolesChange.forEach(function (role) {
      rolesTreated.push({
        id: role.value
      });
    });
    data = {
      ...
      cpf: cpf,
      rg: rg,
      birth_date: "".concat(birthTreated[2], "-").concat(birthTreated[1], "-").concat(birthTreated[0]),
      active: active ? 1 : 0,
      phone1: (0,_Hook_util_help__WEBPACK_IMPORTED_MODULE_9__.formatMask)(phone1 !== null && phone1 !== void 0 ? phone1 : ''),
      phone2: (0,_Hook_util_help__WEBPACK_IMPORTED_MODULE_9__.formatMask)(phone2 !== null && phone2 !== void 0 ? phone2 : ''),
      admission_date: "".concat(admission[2], "-").concat(admission[1], "-").concat(admission[0]),
      emitting_organ: emittingOrgan,
      commission: commission,
      roles: rolesTreated
    };
    password.length ? data['password'] = password : null;
    axios__WEBPACK_IMPORTED_MODULE_6___default().put("/api/v1/employees/".concat(id), data, {
      headers: {
        Authorization: "Bearer ".concat(token)
      }
    }).then(function (response) {
  ...
  var checkUser = function checkUser() {
    var verify = false;
    rolesChange.forEach(function (item) {
  ...
  var setRoles = function setRoles(value) {
    setRolesChange(value);
  };

  if (loading || loadingEmployee) return /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_10__.jsx)(_components_Spinner__WEBPACK_IMPORTED_MODULE_7__["default"], {});
  return /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_10__.jsxs)("div", {
    children: [/*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_10__.jsx)(_components_HeaderButtonPage__WEBPACK_IMPORTED_MODULE_1__["default"], {
      type: 'back',
      ...
      children: [/*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_10__.jsx)(react_bootstrap__WEBPACK_IMPORTED_MODULE_12__["default"], {
        ...
        children: [/*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_10__.jsx)(react_bootstrap__WEBPACK_IMPORTED_MODULE_13__["default"], {
          ...
          children: /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_10__.jsx)(_components_Input__WEBPACK_IMPORTED_MODULE_3__["default"], {
            ...
            value: emittingOrgan,
            onChange: function onChange(e) {
              return setEmittingOrgan(e.target.value);
            },
            required: true,
          ...
          lg: 3,
          children: /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_10__.jsx)(_components_Select2__WEBPACK_IMPORTED_MODULE_8__["default"], {
            value: rolesChange,
            onChange: function onChange(value) {
              return setRoles(value !== null && value !== void 0 ? value : []);
            },
            label: 'Tipo(s)',
            isMulti: true,
            options: allRoles
          ...
          children: /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_10__.jsx)(_components_Input__WEBPACK_IMPORTED_MODULE_3__["default"], {
            ...
            value: commission,
            onChange: function onChange(e) {
              return setCommission(e.target.value);
            },
            label: 'Comissão',
            required: checkUser()
          })
          ...
          children: /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_10__.jsxs)(_components_Button__WEBPACK_IMPORTED_MODULE_2__["default"], {
            disabled: sendingEmployee,
            styleIcon: 'save',
            children: ["Salvar altera\xE7\xF5es", sendingEmployee ? /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_10__.jsx)(_components_Spinner__WEBPACK_IMPORTED_MODULE_7__["default"], {
              size: 'small'
            }) : null]
          })
        })]
      })]
    }), /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_10__.jsx)(_components_SweetAlert__WEBPACK_IMPORTED_MODULE_5__["default"], {
      onConfirm: onClose,
      title: sweetTitle,
      type: sweetType,
