(self["webpackChunk"] = self["webpackChunk"] || []).push([["resources_js_src_System_Admin_PaymentsAdvisors_index_js"],{
...
/***/ "./resources/js/src/System/Admin/PaymentsAdvisors/index.js":
/*!*****************************************************************!*\
  !*** ./resources/js/src/System/Admin/PaymentsAdvisors/index.js ***!
  \*****************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony import */ var _PaymentsAdvisors_module_css__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! ./PaymentsAdvisors.module.css */ "./resources/js/src/System/Admin/PaymentsAdvisors/PaymentsAdvisors.module.css");
...
/* harmony import */ var _components_SweetAlert__WEBPACK_IMPORTED_MODULE_13__ = __webpack_require__(/*! ../../../components/SweetAlert */ "./resources/js/src/components/SweetAlert/index.js");
...
/* harmony import */ var _components_Select2__WEBPACK_IMPORTED_MODULE_15__ = __webpack_require__(/*! ../../../components/Select2 */ "./resources/js/src/components/Select2/index.js");
...
var PaymentsAdvisors = function PaymentsAdvisors() {
  var _payment$created_at, _payment$payment_form, _payment$description;
  ...
  var _useState11 = (0,react__WEBPACK_IMPORTED_MODULE_0__.useState)(new Date().toJSON().slice(0, 10)),
      _useState12 = _slicedToArray(_useState11, 2),
      from = _useState12[0],
      setFrom = _useState12[1];

  var _useState13 = (0,react__WEBPACK_IMPORTED_MODULE_0__.useState)(new Date().toJSON().slice(0, 10)),
  ...
  var _useState15 = (0,react__WEBPACK_IMPORTED_MODULE_0__.useState)([]),
      ...
      allItemsPayment = _useState16[0],
      setAllItemsPayment = _useState16[1];
  ...
  var _useState37 = (0,react__WEBPACK_IMPORTED_MODULE_0__.useState)(''),
      ...
      typeChanged = _useState38[0],
      setTypeChanged = _useState38[1];

  var _useState39 = (0,react__WEBPACK_IMPORTED_MODULE_0__.useState)(null),
      _useState40 = _slicedToArray(_useState39, 2),
      haveAdvisor = _useState40[0],
      setHaveAdvisor = _useState40[1];

  var _useState41 = (0,react__WEBPACK_IMPORTED_MODULE_0__.useState)(0),
      _useState42 = _slicedToArray(_useState41, 2),
      totalSales = _useState42[0],
      setTotalSales = _useState42[1];

  var _useState43 = (0,react__WEBPACK_IMPORTED_MODULE_0__.useState)([]),
      _useState44 = _slicedToArray(_useState43, 2),
      datTable = _useState44[0],
      setDataTable = _useState44[1];

  var _useState45 = (0,react__WEBPACK_IMPORTED_MODULE_0__.useState)(''),
      _useState46 = _slicedToArray(_useState45, 2),
      nameEmployee = _useState46[0],
      setNameEmployee = _useState46[1];
  ...
  var _useState49 = (0,react__WEBPACK_IMPORTED_MODULE_0__.useState)([]),
      ...
      allSellers = _useState50[0],
      setAllSellers = _useState50[1];
  ...
  (0,react__WEBPACK_IMPORTED_MODULE_0__.useEffect)( /*#__PURE__*/_asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee() {
    var employeesTreated, advisorsTreated, employees, advisors;
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            axios__WEBPACK_IMPORTED_MODULE_9___default().get('/api/v1/payment-forms', {
              headers: {
                Authorization: "Bearer ".concat(token)
              }
            }).then(function (response) {
              setAllTransactions(response.data.map(function (transaction) {
                return {
            ...
            employeesTreated = [], advisorsTreated = [];
            _context.next = 4;
            return axios__WEBPACK_IMPORTED_MODULE_9___default().get('/api/v1/employees?all=1', {
              headers: {
                Authorization: "Bearer ".concat(token)
              }
            });
          ...
          case 4:
            ...
            _context.next = 7;
            return axios__WEBPACK_IMPORTED_MODULE_9___default().get('/api/v1/advisors?all=1', {
              headers: {
                Authorization: "Bearer ".concat(token)
              }
            });
          ...
          case 7:
            advisors = _context.sent;
            employees.data.forEach(function (item) {
              employeesTreated.push({
                value: item.id,
                label: "Vendedor - ".concat(item.name)
              });
            });
            setAllSellers([].concat(employeesTreated));
            advisors.data.forEach(function (item) {
              advisorsTreated.push({
                value: item.id,
                label: "Assessor - ".concat(item.name)
              });
              employeesTreated.push({
                value: item.id,
                label: "Assessor - ".concat(item.name)
            ...
            setAllAdvisors([].concat(advisorsTreated));
  ...
  (0,react__WEBPACK_IMPORTED_MODULE_0__.useEffect)(function () {
    ...
    !(0,_Hook_util_help__WEBPACK_IMPORTED_MODULE_10__.isObjectEmpty)(employeeChanged) ? params['employee'] = employeeChanged.label.replaceAll('Vendedor - ', '').replaceAll('Assessor - ', '') : null;
    !(0,_Hook_util_help__WEBPACK_IMPORTED_MODULE_10__.isObjectEmpty)(transactionChange) ? params['payment_form_id'] = transactionChange.value : null;
    axios__WEBPACK_IMPORTED_MODULE_9___default().get("/api/v1/payment-employee-advisor?page=".concat(page), {
      headers: {
        Authorization: "Bearer ".concat(token)
      },
      params: params
      ...
      setPayments(response.data.data.data.map(function (payment) {
        var _payment$seller$name, _payment$seller, _payment$advisor, _payment$seller_id;

        return _objectSpread(_objectSpread({}, payment), {}, {
          name: (_payment$seller$name = payment === null || payment === void 0 ? void 0 : (_payment$seller = payment.seller) === null || _payment$seller === void 0 ? void 0 : _payment$seller.name) !== null && _payment$seller$name !== void 0 ? _payment$seller$name : payment === null || payment === void 0 ? void 0 : (_payment$advisor = payment.advisor) === null || _payment$advisor === void 0 ? void 0 : _payment$advisor.name,
          type: payment !== null && payment !== void 0 && payment.seller ? 'Vendedor' : 'Assessor',
          period: "".concat((0,_Hook_util_help__WEBPACK_IMPORTED_MODULE_10__.formatDate)(payment.date_init), " - ").concat((0,_Hook_util_help__WEBPACK_IMPORTED_MODULE_10__.formatDate)(payment.date_end)),
          ...
          employee_id: (_payment$seller_id = payment.seller_id) !== null && _payment$seller_id !== void 0 ? _payment$seller_id : payment.advisor_id,
          have_advisor: +payment.advisor_id > 0,
          receipt_verified: payment.receipt_verified ? /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_16__.jsx)(react_icons_ai__WEBPACK_IMPORTED_MODULE_17__.AiOutlineCheckCircle, {
  ...
  var generateReceipt = function generateReceipt(item, index) {
    setNameEmployee(item !== null && item !== void 0 && item.advisor ? item.advisor.name : item.seller.name);
    ...
    var params = {
      ...
      from: item.date_init,
      to: item.date_end,
      type: item.type === 'Vendedor' ? 'seller' : 'advisor'
    };
    ...
    setPayment(item);
    axios__WEBPACK_IMPORTED_MODULE_9___default().get('/api/v1/payment-employee-advisor/commission?size=5000', {
      headers: {
        Authorization: "Bearer ".concat(token)
      },
      params: params
      ...
      var totalTreated = 0;
      var total = 0;
      (_response$data = response.data) === null || _response$data === void 0 ? void 0 : _response$data.all_transactions.data.forEach(function (item) {
      ...
      axios__WEBPACK_IMPORTED_MODULE_9___default().post('/api/v1/receipts/verified', dataVerified, {
        headers: {
          Authorization: "Bearer ".concat(token)
        }
      }).then(function () {
        var copyPayments = _toConsumableArray(payments);

        copyPayments[index].receipt_verified = /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_16__.jsx)(react_icons_ai__WEBPACK_IMPORTED_MODULE_17__.AiOutlineCheckCircle, {
          className: 'icon-success'
        });
      ...
      Cell: function Cell(row) {
        return /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_16__.jsxs)(react_jsx_runtime__WEBPACK_IMPORTED_MODULE_16__.Fragment, {
          children: [/*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_16__.jsx)(react_router_dom__WEBPACK_IMPORTED_MODULE_19__.Link, {
            to: "/payments-employees/".concat(row.row.original.id),
            children: /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_16__.jsx)(react_icons_fa__WEBPACK_IMPORTED_MODULE_20__.FaEdit, {
              size: 20,
              color: "#2F4F4F"
            })
            ...
            onClick: function onClick() {
              return generateReceipt(row.row.original, row.row.index);
            },
          ...
          }), /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_16__.jsx)(_components_Button__WEBPACK_IMPORTED_MODULE_12__["default"], {
            type: 'destroy',
            onClick: function onClick() {
              setShow(true);
  ...
  var deleteItem = function deleteItem() {
    setShow(false);
    axios__WEBPACK_IMPORTED_MODULE_9___default()["delete"]("/api/v1/payment-employee-advisor/".concat(idDelete), {
      headers: {
        Authorization: "Bearer ".concat(token)
      }
    }).then(function (response) {
  ...
  var renderProducts = function renderProducts() {
    ...
    return /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_16__.jsx)(_components_Table__WEBPACK_IMPORTED_MODULE_4__["default"], {
      size: 'small',
  ...
  if (loading && role !== null && role !== void 0 && role.length) return /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_16__.jsx)(_components_Spinner__WEBPACK_IMPORTED_MODULE_7__["default"], {});
  return /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_16__.jsxs)(react_jsx_runtime__WEBPACK_IMPORTED_MODULE_16__.Fragment, {
    children: [/*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_16__.jsx)("div", {
      className: _PaymentsAdvisors_module_css__WEBPACK_IMPORTED_MODULE_11__["default"].Receipt,
      id: "section-to-print",
      children: /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_16__.jsxs)("div", {
        className: _PaymentsAdvisors_module_css__WEBPACK_IMPORTED_MODULE_11__["default"].Container,
        children: [/*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_16__.jsx)("div", {
          ...
          children: ["Data: ", (payment === null || payment === void 0 ? void 0 : payment.created_at) && (0,_Hook_util_help__WEBPACK_IMPORTED_MODULE_10__.formatDate)(payment === null || payment === void 0 ? void 0 : (_payment$created_at = payment.created_at) === null || _payment$created_at === void 0 ? void 0 : _payment$created_at.split('T')[0])]
        }), /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_16__.jsxs)("h2", {
          children: ["Operador: ", operator]
        }), /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_16__.jsxs)("h2", {
          children: [typeChanged, ": ", nameEmployee]
        }), /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_16__.jsx)("div", {
          className: 'border my-2'
        }), /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_16__.jsx)("h2", {
          children: "Produtos"
        }), renderProducts(), /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_16__.jsx)("div", {
          className: 'border my-2'
        }), /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_16__.jsx)("h2", {
          children: "Dados do pagamento"
        }), /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_16__.jsxs)("h2", {
          children: ["Forma de pagamento ", payment === null || payment === void 0 ? void 0 : (_payment$payment_form = payment.payment_form) === null || _payment$payment_form === void 0 ? void 0 : _payment$payment_form.name]
        }), /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_16__.jsxs)("h2", {
          style: {
            textAlign: "right"
          },
          children: ["Total: ", parseFloat(totalSales).toLocaleString('pt-BR', {
            minimumFractionDigits: 2,
            style: 'currency',
            currency: 'BRL'
          })]
          ...
          children: ["Comiss\xE3o: ", payment.amount]
        }), payment.description ? /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_16__.jsxs)(react_jsx_runtime__WEBPACK_IMPORTED_MODULE_16__.Fragment, {
          children: [/*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_16__.jsx)("div", {
            className: 'border my-2'
          }), /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_16__.jsx)("h2", {
            className: 'my-2',
            ...
            children: (_payment$description = payment.description) !== null && _payment$description !== void 0 ? _payment$description : ''
          })]
        }) : null]
      })
    }), /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_16__.jsx)(_components_HeaderButtonPage__WEBPACK_IMPORTED_MODULE_1__["default"], {
      showStore: true,
      h1: 'Pagamentos',
      type: 'store',
      to: '/payments-employees/create',
      title: 'Cadastrar'
    }), /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_16__.jsx)(_components_Filter__WEBPACK_IMPORTED_MODULE_2__["default"], {
      children: /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_16__.jsxs)(react_bootstrap__WEBPACK_IMPORTED_MODULE_21__["default"], {
        children: [/*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_16__.jsx)(react_bootstrap__WEBPACK_IMPORTED_MODULE_22__["default"], {
          lg: 3,
          children: /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_16__.jsx)(_components_Input__WEBPACK_IMPORTED_MODULE_3__["default"], {
            type: 'date',
          ...
          lg: 3,
          children: /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_16__.jsx)(_components_Select2__WEBPACK_IMPORTED_MODULE_15__["default"], {
            label: 'Funcionário',
            value: employeeChanged,
            onChange: function onChange(value) {
              setEmployeeChanged(value !== null && value !== void 0 ? value : {});
              setPage(1);
            },
          ...
          children: /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_16__.jsx)(_components_Select2__WEBPACK_IMPORTED_MODULE_15__["default"], {
            ...
            onChange: function onChange(value) {
              setTransactionChange(value !== null && value !== void 0 ? value : {});
              setPage(1);
            },
            isClearable: true
          })
    ...
    }), /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_16__.jsxs)("h1", {
      style: {
        textAlign: "right"
      },
      children: ["Total: ", total.toLocaleString('pt-BR', {
        minimumFractionDigits: 2,
        style: 'currency',
        currency: 'BRL'
      })]
    }), payments.length ? /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_16__.jsx)(_components_Table__WEBPACK_IMPORTED_MODULE_4__["default"], {
      columns: columns,
      data: payments
    }) : /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_16__.jsx)(_components_Message__WEBPACK_IMPORTED_MODULE_5__["default"], {
      type: 'info',
      children: "Nenhum pagamento realizado"
    }), !(totalItemsCount > itemsCountPerPage) ? null : /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_16__.jsx)(_components_Pagination__WEBPACK_IMPORTED_MODULE_6__["default"], {
    ...
    }), /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_16__.jsx)(_components_SweetAlert__WEBPACK_IMPORTED_MODULE_13__["default"], {
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (PaymentsAdvisors);
