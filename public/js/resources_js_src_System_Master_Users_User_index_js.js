"use strict";
(self["webpackChunk"] = self["webpackChunk"] || []).push([["resources_js_src_System_Master_Users_User_index_js"],{
...
/***/ "./resources/js/src/System/Master/Users/User/index.js":
/*!************************************************************!*\
  !*** ./resources/js/src/System/Master/Users/User/index.js ***!
  \************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
var User = function User() {
  ...
  var _useState15 = (0,react__WEBPACK_IMPORTED_MODULE_0__.useState)(''),
      ...
      passwordConfirmation = _useState16[0],
      setPasswordConfirmation = _useState16[1];

  var _useState17 = (0,react__WEBPACK_IMPORTED_MODULE_0__.useState)({}),
      _useState18 = _slicedToArray(_useState17, 2),
      company = _useState18[0],
      setCompany = _useState18[1];

  var _useState19 = (0,react__WEBPACK_IMPORTED_MODULE_0__.useState)([]),
      _useState20 = _slicedToArray(_useState19, 2),
      allRoles = _useState20[0],
      setAllRoles = _useState20[1];

  var _useState21 = (0,react__WEBPACK_IMPORTED_MODULE_0__.useState)([]),
      _useState22 = _slicedToArray(_useState21, 2),
      rolesChange = _useState22[0],
      setRolesChange = _useState22[1];

  var _useState23 = (0,react__WEBPACK_IMPORTED_MODULE_0__.useState)([]),
      _useState24 = _slicedToArray(_useState23, 2),
      allCompanies = _useState24[0],
      setAllCompanies = _useState24[1];

  var _useState25 = (0,react__WEBPACK_IMPORTED_MODULE_0__.useState)(true),
      _useState26 = _slicedToArray(_useState25, 2),
      loadingRoles = _useState26[0],
      setLoadingRoles = _useState26[1];

  var _useState27 = (0,react__WEBPACK_IMPORTED_MODULE_0__.useState)(true),
      _useState28 = _slicedToArray(_useState27, 2),
      loadingCompanies = _useState28[0],
      setLoadingCompanies = _useState28[1];

  var _useState29 = (0,react__WEBPACK_IMPORTED_MODULE_0__.useState)(false),
      _useState30 = _slicedToArray(_useState29, 2),
      showCompany = _useState30[0],
      setShowCompany = _useState30[1];

  var _useState31 = (0,react__WEBPACK_IMPORTED_MODULE_0__.useState)(false),
      _useState32 = _slicedToArray(_useState31, 2),
      showMessageError = _useState32[0],
      setShowMessageError = _useState32[1];
  ...
  (0,react__WEBPACK_IMPORTED_MODULE_0__.useEffect)(function () {
    axios.get("/api/v1/users/".concat(id), {
      headers: {
      ...
      var rolesTreated = response.data.roles.map(function (role) {
        return {
          value: role.id,
          label: (0,_Hook_util_help__WEBPACK_IMPORTED_MODULE_10__.formatTypeUser)(role.name)
        };
      });
      setRolesChange(rolesTreated);
      setShowCompany(checkTypeUser(rolesTreated, 'Administrador'));

      if (response !== null && response !== void 0 && (_response$data = response.data) !== null && _response$data !== void 0 && _response$data.company) {
        var _response$data2, _response$data2$compa, _response$data3, _response$data3$compa;

        setShowCompany(true);
        setCompany({
          value: response === null || response === void 0 ? void 0 : (_response$data2 = response.data) === null || _response$data2 === void 0 ? void 0 : (_response$data2$compa = _response$data2.company) === null || _response$data2$compa === void 0 ? void 0 : _response$data2$compa.id,
          label: (_response$data3 = response.data) === null || _response$data3 === void 0 ? void 0 : (_response$data3$compa = _response$data3.company) === null || _response$data3$compa === void 0 ? void 0 : _response$data3$compa.name
        });
      } else {
        setCompany({});
      }
  ...
  (0,react__WEBPACK_IMPORTED_MODULE_0__.useEffect)(function () {
    ...
    axios.get('/api/v1/companies?all=1', {
      ...
      setAllCompanies(response.data.map(function (company) {
        return {
          value: company.id,
          label: company.name
        };
  ...
  var handlerSubmit = function handlerSubmit(e) {
    ...
    if (passwordConfirmation === password) {
      ...
      axios.put("/api/v1/users/".concat(id), data, {
        headers: {
          Authorization: "Bearer ".concat(token)
        }
      }).then(function (response) {
  ...
  var checkTypeUser = function checkTypeUser(roles, role) {
    var verify = false;
  ...
  if (loadingRoles || loadingCompanies || loading) return /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_11__.jsx)(_components_Spinner__WEBPACK_IMPORTED_MODULE_7__["default"], {});
  return /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_11__.jsxs)("div", {
    children: [/*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_11__.jsx)(_components_HeaderButtonPage__WEBPACK_IMPORTED_MODULE_1__["default"], {
      type: 'back',
      h2: 'Detalhes do usuário'
    }), /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_11__.jsx)(_components_CardForm__WEBPACK_IMPORTED_MODULE_6__["default"], {
      type: 'smaller',
      children: /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_11__.jsxs)("form", {
        onSubmit: handlerSubmit,
        children: [/*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_11__.jsx)(_components_Select2__WEBPACK_IMPORTED_MODULE_8__["default"], {
          value: rolesChange,
          ...
          isMulti: true,
          options: allRoles
        }), !showCompany ? null : /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_11__.jsx)(_components_Select2__WEBPACK_IMPORTED_MODULE_8__["default"], {
          value: company,
          onChange: setCompany,
          label: 'Empresa',
        ...
        }), showMessageError ? /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_11__.jsx)(_components_Message__WEBPACK_IMPORTED_MODULE_9__["default"], {
          type: 'error',
          children: "Confirme a senha"
        }) : null, /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_11__.jsx)(_components_Button__WEBPACK_IMPORTED_MODULE_3__["default"], {
          styleIcon: 'save',
          children: "Salvar altera\xE7\xF5es"
        })]
      })
    }), /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_11__.jsx)(_components_SweetAlert__WEBPACK_IMPORTED_MODULE_5__["default"], {
      onConfirm: onClose,
      title: sweetTitle,
      type: sweetType,
