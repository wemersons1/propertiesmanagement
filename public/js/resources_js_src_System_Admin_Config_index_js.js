"use strict";
(self["webpackChunk"] = self["webpackChunk"] || []).push([["resources_js_src_System_Admin_Config_index_js"],{

/***/ "./resources/js/src/System/Admin/Config/index.js":
/*!*******************************************************!*\
  !*** ./resources/js/src/System/Admin/Config/index.js ***!
  \*******************************************************/
...
var Config = function Config() {
  ...
  var _useState21 = (0,react__WEBPACK_IMPORTED_MODULE_0__.useState)(false),
      ...
      applyDiscount = _useState22[0],
      setApplyDiscount = _useState22[1];

  var _useState23 = (0,react__WEBPACK_IMPORTED_MODULE_0__.useState)(false),
      _useState24 = _slicedToArray(_useState23, 2),
      haveAdvisor = _useState24[0],
      setHaveAdvisor = _useState24[1];

  (0,react__WEBPACK_IMPORTED_MODULE_0__.useEffect)(function () {
    axios__WEBPACK_IMPORTED_MODULE_6___default().get('/api/v1/config-system/admin', {
      headers: {
  ...
  var handlerSubmit = function handlerSubmit(e) {
    ...
    axios__WEBPACK_IMPORTED_MODULE_6___default().put('/api/v1/config-system/admin', data, {
      headers: {
        Authorization: "Bearer ".concat(token)
      }
    }).then(function (response) {
