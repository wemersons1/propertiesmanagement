(self["webpackChunk"] = self["webpackChunk"] || []).push([["resources_js_src_System_Admin_PaymentsAdvisors_PaymentAdvisor_index_js"],{
...
/***/ "./resources/js/src/System/Admin/PaymentsAdvisors/PaymentAdvisor/index.js":
/*!********************************************************************************!*\
  !*** ./resources/js/src/System/Admin/PaymentsAdvisors/PaymentAdvisor/index.js ***!
  \********************************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony import */ var _Create_Create_module_css__WEBPACK_IMPORTED_MODULE_16__ = __webpack_require__(/*! ../Create/Create.module.css */ "./resources/js/src/System/Admin/PaymentsAdvisors/Create/Create.module.css");
...
var PaymentAdvisor = function PaymentAdvisor() {
  ...
  var _useState13 = (0,react__WEBPACK_IMPORTED_MODULE_0__.useState)([]),
      ...
      allAdvisors = _useState14[0],
      setAllAdvisors = _useState14[1];

  var _useState15 = (0,react__WEBPACK_IMPORTED_MODULE_0__.useState)([]),
      _useState16 = _slicedToArray(_useState15, 2),
      allSellers = _useState16[0],
      setAllSellers = _useState16[1];
  ...
  var _useState19 = (0,react__WEBPACK_IMPORTED_MODULE_0__.useState)('advisor'),
  ...
  var _useState21 = (0,react__WEBPACK_IMPORTED_MODULE_0__.useState)(''),
      ...
      dateInit = _useState22[0],
      setDateInit = _useState22[1];

  var _useState23 = (0,react__WEBPACK_IMPORTED_MODULE_0__.useState)(''),
      _useState24 = _slicedToArray(_useState23, 2),
      dateEnd = _useState24[0],
      setDateEnd = _useState24[1];

  var _useState25 = (0,react__WEBPACK_IMPORTED_MODULE_0__.useState)({}),
      _useState26 = _slicedToArray(_useState25, 2),
      employeeChanged = _useState26[0],
      setEmployeeChanged = _useState26[1];

  var _useState27 = (0,react__WEBPACK_IMPORTED_MODULE_0__.useState)([]),
      _useState28 = _slicedToArray(_useState27, 2),
      allItems = _useState28[0],
      setAllItems = _useState28[1];
  ...
  var _useState31 = (0,react__WEBPACK_IMPORTED_MODULE_0__.useState)(0),
      ...
      itemsCountPerPage = _useState32[0],
      setItemsCountPerPage = _useState32[1];

  var _useState33 = (0,react__WEBPACK_IMPORTED_MODULE_0__.useState)(0),
      _useState34 = _slicedToArray(_useState33, 2),
      totalItemsCount = _useState34[0],
      setTotalItemsCount = _useState34[1];

  var _useState35 = (0,react__WEBPACK_IMPORTED_MODULE_0__.useState)(true),
      _useState36 = _slicedToArray(_useState35, 2),
      loadingPayment = _useState36[0],
      setLoadingPayment = _useState36[1];

  var _useState37 = (0,react__WEBPACK_IMPORTED_MODULE_0__.useState)(''),
      _useState38 = _slicedToArray(_useState37, 2),
      formChanged = _useState38[0],
      setFormChanged = _useState38[1];
  ...
  var _useState41 = (0,react__WEBPACK_IMPORTED_MODULE_0__.useState)([]),
      ...
      setAllPaymentsForms = _useState42[1];
  ...
  var _useState43 = (0,react__WEBPACK_IMPORTED_MODULE_0__.useState)(0),
      ...
      totalPaid = _useState44[0],
      setTotalPaid = _useState44[1];
  ...
  (0,react__WEBPACK_IMPORTED_MODULE_0__.useEffect)( /*#__PURE__*/_asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee() {
    var response, advisors, params, payment, _payment$data$descrip, allProducts;
    ...
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            _context.next = 2;
            return axios__WEBPACK_IMPORTED_MODULE_6___default().get('/api/v1/users?role_name=seller&all=1', {
              headers: {
                Authorization: "Bearer ".concat(token)
              }
            });
          ...
          case 2:
            ...
            if (response) {
              setAllSellers(response.data.map(function (seller) {
                return {
            ...
            _context.next = 6;
            return axios__WEBPACK_IMPORTED_MODULE_6___default().get('/api/v1/advisors?all=1', {
              headers: {
                Authorization: "Bearer ".concat(token)
              }
            });
          ...
          case 6:
            ...
            if (advisors) {
              setAllAdvisors(advisors.data.map(function (seller) {
                return {
                  value: seller.id,
                  label: seller.name
                };
            ...
            _context.next = 11;
            return axios__WEBPACK_IMPORTED_MODULE_6___default().get("/api/v1/payment-employee-advisor/".concat(id), {
              headers: {
                Authorization: "Bearer ".concat(token)
              },
              params: params
            ...
            if (payment) {
              ...
              setAllItems(allProducts.map(function (item) {
                return _objectSpread(_objectSpread({}, item), {}, {
                  ...
                  quantity: "".concat(item.quantity, "x ").concat(parseFloat(item.price_final).toLocaleString('pt-BR', {
                    minimumFractionDigits: 2,
                    style: 'currency',
                    currency: 'BRL'
                  })),
                  ...
                  created_at: (0,_Hook_util_help__WEBPACK_IMPORTED_MODULE_12__.formatDate)(item.created_at.split(' ')[0]) + " ".concat(item.created_at.split(' ')[1])
                });
              }));
              ...
              setDescription((_payment$data$descrip = payment.data.description) !== null && _payment$data$descrip !== void 0 && _payment$data$descrip.length ? payment.data.description : '');
              ...
              if (payment.data.advisor_id) {
                advisors.data.forEach(function (advisor) {
  ...
  var handlerSubmit = function handlerSubmit(e) {
    ...
    axios__WEBPACK_IMPORTED_MODULE_6___default().put("/api/v1/payment-employee-advisor/".concat(id), data, {
      headers: {
        Authorization: "Bearer ".concat(token)
      }
    }).then(function (response) {
  ...
  if (loadingPayment || loadingPaymentsForms) return /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_17__.jsx)(_components_Spinner__WEBPACK_IMPORTED_MODULE_15__["default"], {});
  return /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_17__.jsxs)("div", {
    children: [/*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_17__.jsx)(_components_HeaderButtonPage__WEBPACK_IMPORTED_MODULE_1__["default"], {
      type: 'back',
      h2: 'Detalhes do pagamento'
    }), /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_17__.jsx)("form", {
      onSubmit: handlerSubmit,
      children: /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_17__.jsxs)(_components_CardForm__WEBPACK_IMPORTED_MODULE_7__["default"], {
        height: 'full',
        children: [/*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_17__.jsxs)(react_bootstrap__WEBPACK_IMPORTED_MODULE_19__["default"], {
          children: [/*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_17__.jsx)(react_bootstrap__WEBPACK_IMPORTED_MODULE_20__["default"], {
            lg: 2,
            children: /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_17__.jsxs)(_components_Select__WEBPACK_IMPORTED_MODULE_8__["default"], {
              value: type,
              label: 'Tipo',
          ...
          }), /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_17__.jsx)(react_bootstrap__WEBPACK_IMPORTED_MODULE_20__["default"], {
            lg: 2,
            children: /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_17__.jsx)(_components_Select2__WEBPACK_IMPORTED_MODULE_9__["default"], {
              label: "Selecione o ".concat(type === 'advisor' ? 'Assessor' : 'Vendedor'),
            ...
            lg: 2,
            children: /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_17__.jsx)(_components_InputMoney__WEBPACK_IMPORTED_MODULE_10__["default"], {
            ...
            lg: 2,
            children: /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_17__.jsx)(_components_Input__WEBPACK_IMPORTED_MODULE_2__["default"], {
              type: 'date',
              value: dateInit,
              onChange: function onChange(e) {
                return setDateInit(e.target.value);
              }
            })
          }), /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_17__.jsx)(react_bootstrap__WEBPACK_IMPORTED_MODULE_20__["default"], {
            lg: 2,
        ...
        }), /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_17__.jsx)(react_bootstrap__WEBPACK_IMPORTED_MODULE_19__["default"], {
          className: 'p-3',
          children: allPaymentsForms.map(function (form) {
            return /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_17__.jsx)(react_bootstrap__WEBPACK_IMPORTED_MODULE_20__["default"], {
              children: /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_17__.jsxs)("div", {
                className: _Create_Create_module_css__WEBPACK_IMPORTED_MODULE_16__["default"].Radio,
          ...
          children: /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_17__.jsx)(react_bootstrap__WEBPACK_IMPORTED_MODULE_20__["default"], {
            children: /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_17__.jsx)(_components_TextArea__WEBPACK_IMPORTED_MODULE_11__["default"], {
              value: description,
              label: 'Descrição',
              onChange: function onChange(e) {
        ...
        }), /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_17__.jsx)(_components_Button__WEBPACK_IMPORTED_MODULE_3__["default"], {
          styleIcon: 'save',
          children: "Salva altera\xE7\xF5es"
        }), !allItems.length ? null : /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_17__.jsx)(_components_Table__WEBPACK_IMPORTED_MODULE_13__["default"], {
          columns: columns,
          data: allItems
        }), !(totalItemsCount > itemsCountPerPage) ? null : /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_17__.jsx)(_components_Pagination__WEBPACK_IMPORTED_MODULE_14__["default"], {
    ...
    }), /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_17__.jsx)(_components_SweetAlert__WEBPACK_IMPORTED_MODULE_5__["default"], {
      onConfirm: onClose,
      title: sweetTitle,
      type: sweetType,
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (PaymentAdvisor);
...
/***/ "./node_modules/css-loader/dist/cjs.js??ruleSet[1].rules[6].oneOf[1].use[1]!./node_modules/postcss-loader/dist/cjs.js??ruleSet[1].rules[6].oneOf[1].use[2]!./resources/js/src/System/Admin/PaymentsAdvisors/Create/Create.module.css":
/*!*******************************************************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/css-loader/dist/cjs.js??ruleSet[1].rules[6].oneOf[1].use[1]!./node_modules/postcss-loader/dist/cjs.js??ruleSet[1].rules[6].oneOf[1].use[2]!./resources/js/src/System/Admin/PaymentsAdvisors/Create/Create.module.css ***!
  \*******************************************************************************************************************************************************************************************************************************************/
...
// Module
___CSS_LOADER_EXPORT___.push([module.id, ".MmjiI3M9T8QBG43YkgVWbQ\\=\\= {\n    display: flex;\n    align-items: center;\n}\n\n.MmjiI3M9T8QBG43YkgVWbQ\\=\\= label {\n    padding: 0;\n    margin: 0;\n    font-size: 1.3rem;\n    font-weight: bold;\n}\n", ""]);
// Exports
___CSS_LOADER_EXPORT___.locals = {
	"Radio": "MmjiI3M9T8QBG43YkgVWbQ=="
};
...
/***/ "./resources/js/src/System/Admin/PaymentsAdvisors/Create/Create.module.css":
/*!*********************************************************************************!*\
  !*** ./resources/js/src/System/Admin/PaymentsAdvisors/Create/Create.module.css ***!
  \*********************************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
