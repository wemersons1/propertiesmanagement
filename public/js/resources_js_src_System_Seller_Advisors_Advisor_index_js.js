"use strict";
(self["webpackChunk"] = self["webpackChunk"] || []).push([["resources_js_src_System_Seller_Advisors_Advisor_index_js"],{

/***/ "./resources/js/src/System/Seller/Advisors/Advisor/index.js":
/*!******************************************************************!*\
  !*** ./resources/js/src/System/Seller/Advisors/Advisor/index.js ***!
  \******************************************************************/
...
var Create = function Create() {
  ...
  var _useState13 = (0,react__WEBPACK_IMPORTED_MODULE_0__.useState)(''),
      ...
      document = _useState14[0],
      setDocument = _useState14[1];
  ...
  var _useState17 = (0,react__WEBPACK_IMPORTED_MODULE_0__.useState)(''),
      ...
      phone1 = _useState18[0],
      setPhone1 = _useState18[1];
  ...
  (0,react__WEBPACK_IMPORTED_MODULE_0__.useEffect)(function () {
    axios.get("/api/v1/advisors/".concat(id), {
      headers: {
        Authorization: "Bearer ".concat(token)
      }
    }).then(function (response) {
      var _response$data$docume, _response$data$rg, _response$data$phone, _response$data$email;

      setName(response.data.name);
      setDocument((_response$data$docume = response.data.document) !== null && _response$data$docume !== void 0 ? _response$data$docume : '');
      setRg((_response$data$rg = response.data.rg) !== null && _response$data$rg !== void 0 ? _response$data$rg : '');
      setPhone1((_response$data$phone = response.data.phone1) !== null && _response$data$phone !== void 0 ? _response$data$phone : '');
      setEmail((_response$data$email = response.data.email) !== null && _response$data$email !== void 0 ? _response$data$email : '');
    })["finally"](function () {
      setLoading(false);
    });
  }, []);
  ...
  var handlerSubmit = function handlerSubmit(e) {
    ...
    data['name'] = name;
    data['email'] = email;
    data['document'] = (0,_Hook_util_help__WEBPACK_IMPORTED_MODULE_8__.formatMask)(document);
    data['rg'] = rg;
    data['phone1'] = (0,_Hook_util_help__WEBPACK_IMPORTED_MODULE_8__.formatMask)(phone1);
    axios.put("/api/v1/advisors/".concat(id), data, {
      headers: {
        Authorization: "Bearer ".concat(token)
      }
    }).then(function (response) {
      setSweetText('Assessor alterado com sucesso');
  ...
  return /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_9__.jsxs)("div", {
    children: [/*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_9__.jsx)(_components_HeaderButtonPage__WEBPACK_IMPORTED_MODULE_1__["default"], {
      type: 'back',
      h2: 'Detalhes do Assessor'
    }), /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_9__.jsx)(_components_CardForm__WEBPACK_IMPORTED_MODULE_6__["default"], {
      type: 'smaller',
