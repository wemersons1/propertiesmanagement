(self["webpackChunk"] = self["webpackChunk"] || []).push([["resources_js_src_System_Clerk_Dashboard_index_js"],{
...
/***/ "./resources/js/src/System/Clerk/Dashboard/index.js":
/*!**********************************************************!*\
  !*** ./resources/js/src/System/Clerk/Dashboard/index.js ***!
  \**********************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony import */ var _Clerk_Dashboard_Dashboard_module_css__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ../../Clerk/Dashboard/Dashboard.module.css */ "./resources/js/src/System/Clerk/Dashboard/Dashboard.module.css");
...
/* harmony import */ var _components_Message__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ../../../components/Message */ "./resources/js/src/components/Message/index.js");
...
/* harmony import */ var _components_Chart__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ../../../components/Chart */ "./resources/js/src/components/Chart/index.js");
...
var Dashboard = function Dashboard() {
  var _report$total_sales, _report$total_pending, _report$total_cancele, _report$quantity_sale;
  ...
  var _useState11 = (0,react__WEBPACK_IMPORTED_MODULE_0__.useState)([]),
      ...
      paymentsTypes = _useState12[0],
      setPaymentsTypes = _useState12[1];

  var _useState13 = (0,react__WEBPACK_IMPORTED_MODULE_0__.useState)([]),
      _useState14 = _slicedToArray(_useState13, 2),
      quantityStatusesCarts = _useState14[0],
      setQuantityStatusesCarts = _useState14[1];
  ...
  var _useState17 = (0,react__WEBPACK_IMPORTED_MODULE_0__.useState)([]),
      ...
      labelPaymentType = _useState18[0],
      setLabelPaymentType = _useState18[1];

  var _useState19 = (0,react__WEBPACK_IMPORTED_MODULE_0__.useState)([]),
      _useState20 = _slicedToArray(_useState19, 2),
      typePayment = _useState20[0],
      setPaymentType = _useState20[1];
  ...
  (0,react__WEBPACK_IMPORTED_MODULE_0__.useEffect)(function () {
    ...
    axios.get('/api/v1/report/clerk', {
      ...
      if (response.data.quantity_sales_by_seller) {
        var quantity = [];
        var labels = [];
        response.data.payments_types.forEach(function (item) {
      ...
      var totalTreated = 0;
      var payments = [];
      payments.push(["Per\xEDodo ".concat((0,_Hook_util_help__WEBPACK_IMPORTED_MODULE_8__.formatDate)(!from ? today : (0,_Hook_util_help__WEBPACK_IMPORTED_MODULE_8__.formatDatePick)(from)), " - ").concat((0,_Hook_util_help__WEBPACK_IMPORTED_MODULE_8__.formatDate)(!to ? today : (0,_Hook_util_help__WEBPACK_IMPORTED_MODULE_8__.formatDatePick)(to))), 'Pagamentos']);
      response.data.payments_types.forEach(function (item) {
      ...
      var quantityTotalCarts = [];
      quantityTotalCarts.push(["Status", "Quantidade por status"]);
      response.data.total_carts.forEach(function (cart) {
      ...
      setOrders(response.data.lasts_orders.map(function (model) {
        var _model$advisor, _model$advisor2, _model$advisor3;
        ...
        return _objectSpread(_objectSpread({}, model), {}, {
          id: model.id,
          client: (0,_Hook_util_help__WEBPACK_IMPORTED_MODULE_8__.firstLetterUppercase)(model.client.name),
          status: (0,_Hook_util_help__WEBPACK_IMPORTED_MODULE_8__.translateStatusPayment)(model.status.name),
          created_at: createdTreated,
          advisor: model !== null && model !== void 0 && (_model$advisor = model.advisor) !== null && _model$advisor !== void 0 && _model$advisor.name ? (0,_Hook_util_help__WEBPACK_IMPORTED_MODULE_8__.firstLetterUppercase)(model === null || model === void 0 ? void 0 : (_model$advisor2 = model.advisor) === null || _model$advisor2 === void 0 ? void 0 : _model$advisor2.name) : 'Sem assessor',
          seller: (0,_Hook_util_help__WEBPACK_IMPORTED_MODULE_8__.firstLetterUppercase)(model.employee.name),
          ...
          payment_form: /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_11__.jsx)("span", {
            className: 'fw-bold',
            children: model === null || model === void 0 ? void 0 : model.payment_form.name
          })
        });
      }));
    })["finally"](function () {
  ...
  if (loading) return /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_11__.jsx)(_components_Spinner__WEBPACK_IMPORTED_MODULE_2__["default"], {});
  return /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_11__.jsxs)("div", {
    children: [/*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_11__.jsx)("h1", {
      ...
      children: [/*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_11__.jsx)(react_bootstrap__WEBPACK_IMPORTED_MODULE_15__["default"], {
        md: 3,
        children: /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_11__.jsx)(react_modern_calendar_datepicker__WEBPACK_IMPORTED_MODULE_6__["default"], {
          value: from,
          onChange: setFrom,
          inputPlaceholder: from,
          shouldHighlightWeekends: true,
          inputClassName: _Clerk_Dashboard_Dashboard_module_css__WEBPACK_IMPORTED_MODULE_7__["default"].InputDate // custom class
          ,
          formatInputText: function formatInputText() {
            var today = new Date().toJSON().slice(0, 10);
            if (!from) return (0,_Hook_util_help__WEBPACK_IMPORTED_MODULE_8__.formatDate)(today);
            return (0,_Hook_util_help__WEBPACK_IMPORTED_MODULE_8__.formatDateInput)(from);
          }
        })
      }), /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_11__.jsx)(react_bootstrap__WEBPACK_IMPORTED_MODULE_15__["default"], {
        md: 3,
        children: /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_11__.jsx)(react_modern_calendar_datepicker__WEBPACK_IMPORTED_MODULE_6__["default"], {
          value: to,
          onChange: setTo,
          ...
          formatInputText: function formatInputText() {
            var today = new Date().toJSON().slice(0, 10);
            if (!to) return (0,_Hook_util_help__WEBPACK_IMPORTED_MODULE_8__.formatDate)(today);
            return (0,_Hook_util_help__WEBPACK_IMPORTED_MODULE_8__.formatDateInput)(to);
          }
        })
      })]
    }), /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_11__.jsxs)(react_bootstrap__WEBPACK_IMPORTED_MODULE_14__["default"], {
      children: [/*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_11__.jsx)(react_bootstrap__WEBPACK_IMPORTED_MODULE_15__["default"], {
        lg: 3,
        children: /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_11__.jsx)(_components_Card__WEBPACK_IMPORTED_MODULE_1__["default"], {
          type: 'model-2',
          title: 'Total recebido',
          icon: /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_11__.jsx)(react_icons_md__WEBPACK_IMPORTED_MODULE_16__.MdOutlineAttachMoney, {
            className: "icon-left",
            style: {
              fill: "#00c383"
            },
          ...
          value: parseFloat((_report$total_sales = report === null || report === void 0 ? void 0 : report.total_sales) !== null && _report$total_sales !== void 0 ? _report$total_sales : 0).toLocaleString('pt-BR', {
            minimumFractionDigits: 2,
            style: 'currency',
            currency: 'BRL'
          })
        ...
        children: /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_11__.jsx)(_components_Card__WEBPACK_IMPORTED_MODULE_1__["default"], {
          ...
          value: parseFloat((_report$total_pending = report === null || report === void 0 ? void 0 : report.total_pending) !== null && _report$total_pending !== void 0 ? _report$total_pending : 0).toLocaleString('pt-BR', {
            minimumFractionDigits: 2,
            style: 'currency',
            currency: 'BRL'
          })
        ...
        children: /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_11__.jsx)(_components_Card__WEBPACK_IMPORTED_MODULE_1__["default"], {
          ...
          value: parseFloat((_report$total_cancele = report === null || report === void 0 ? void 0 : report.total_canceled) !== null && _report$total_cancele !== void 0 ? _report$total_cancele : 0).toLocaleString('pt-BR', {
            minimumFractionDigits: 2,
            style: 'currency',
            currency: 'BRL'
          })
        ...
        children: /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_11__.jsx)(_components_Card__WEBPACK_IMPORTED_MODULE_1__["default"], {
          ...
          icon: /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_11__.jsx)(react_icons_md__WEBPACK_IMPORTED_MODULE_16__.MdLeaderboard, {
            className: "icon-left",
            style: {
              fill: "#2596be"
            },
          ...
          value: (_report$quantity_sale = report.quantity_sales) !== null && _report$quantity_sale !== void 0 ? _report$quantity_sale : 0
        })
      })]
    }), /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_11__.jsx)(react_bootstrap__WEBPACK_IMPORTED_MODULE_14__["default"], {
      children: typePayment.length ? /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_11__.jsx)(react_bootstrap__WEBPACK_IMPORTED_MODULE_15__["default"], {
        md: 6,
        children: /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_11__.jsx)(_components_Card__WEBPACK_IMPORTED_MODULE_1__["default"], {
          title: 'Quantidade de vendas por vendedor',
          children: /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_11__.jsx)(_components_Chart__WEBPACK_IMPORTED_MODULE_10__["default"], {
            type: 'polar',
            data: typePayment,
      ...
      children: orders.length ? /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_11__.jsx)(_components_Table__WEBPACK_IMPORTED_MODULE_4__["default"], {
        columns: columns,
        data: orders
      }) : /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_11__.jsx)(_components_Message__WEBPACK_IMPORTED_MODULE_9__["default"], {
        type: 'info',
        children: "Nenhum pedido pendente dentro do per\xEDodo"
      })
    })]
  });
};
...
/***/ "./resources/js/src/components/Chart/index.js":
/*!****************************************************!*\
  !*** ./resources/js/src/components/Chart/index.js ***!
  \****************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
var Chart = function Chart(_ref) {
  var type = _ref.type,
      ...
      title = _ref.title,
      size = _ref.size,
      nameItem = _ref.nameItem,
      horizontal = _ref.horizontal;

  if (type === 'bar') {
    var attributes = {
      series: [{
        name: nameItem !== null && nameItem !== void 0 ? nameItem : 'Vendas',
        data: data
      }],
      options: {
        annotations: {
...
/***/ "./node_modules/css-loader/dist/cjs.js??ruleSet[1].rules[6].oneOf[1].use[1]!./node_modules/postcss-loader/dist/cjs.js??ruleSet[1].rules[6].oneOf[1].use[2]!./resources/js/src/System/Clerk/Dashboard/Dashboard.module.css":
/*!********************************************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/css-loader/dist/cjs.js??ruleSet[1].rules[6].oneOf[1].use[1]!./node_modules/postcss-loader/dist/cjs.js??ruleSet[1].rules[6].oneOf[1].use[2]!./resources/js/src/System/Clerk/Dashboard/Dashboard.module.css ***!
  \********************************************************************************************************************************************************************************************************************************/
/***/ ((module, __webpack_exports__, __webpack_require__) => {
...
// Module
___CSS_LOADER_EXPORT___.push([module.id, ".mVU-Tq3RAYLRiovrRcU4hw\\=\\= {\n    width: 100%;\n    padding: .5rem;\n    border-radius: .2rem;\n    font-size: 2rem;\n    color: var(--color-light-dark);\n    margin: .5rem auto;\n}\n\n.mVU-Tq3RAYLRiovrRcU4hw\\=\\=:focus {\n    outline: none;\n    box-shadow: rgba(0, 0, 0, 0.35) 2.4px 2.4px 7px;\n}\n", ""]);
// Exports
___CSS_LOADER_EXPORT___.locals = {
	"InputDate": "mVU-Tq3RAYLRiovrRcU4hw=="
};
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (___CSS_LOADER_EXPORT___);
...
/***/ "./resources/js/src/System/Clerk/Dashboard/Dashboard.module.css":
/*!**********************************************************************!*\
  !*** ./resources/js/src/System/Clerk/Dashboard/Dashboard.module.css ***!
  \**********************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
